...
export default class SignUp extends Component {
  constructor (props) {
    ...
    this.saveAreaOfInterest = this.saveAreaOfInterest.bind(this)
  ...
  saveAreaOfInterest (e) {
    this.setState({ areaOfInterest: e.target.value || null })
  }
  ...
  toggleCheckbox = label => {
    if (this.state.selectedCheckboxes.includes(label)) {
      this.setState((oldState) => {
        return {
          selectedCheckboxes: oldState.selectedCheckboxes.filter(item => {
            return item != label
          })
        }
      });
      ...
      this.setState((oldState) => {
        return {
          selectedCheckboxes: oldState.selectedCheckboxes.concat(label)
        }
      });
    }
  }
  ...
  createCheckboxes = () => (
    this.state.itemsAreas.map(this.createCheckbox)
  )
          ...
          (
            <div id='signup-form'>
              ...
              <FormAsync
                ...
                <div className='form-group'>
                  <label htmlFor=''><i>(OPCIONAL)</i> ¿En cuál de los siguientes sectores desarrollas tu actividad?</label>
                   {/* {this.createCheckboxes()}
                   <input
                    type='hidden'
                    id='areasOfInterest'
                    name='areasOfInterest'
                    value={this.state.selectedCheckboxes.join(',')}
                    /> */}
                    <select value={this.state.areaOfInterest} id='areaOfInterest' name='areaOfInterest' onChange={this.saveAreaOfInterest} className="form-control">
                      <option value={''}>- Seleccione una opción -</option>
                      {
                        this.state.itemsAreas.map((i) => <option value={i}>{i}</option>)
                      }
                    </select>
                </div>
                <div className='form-group'>
